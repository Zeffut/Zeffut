...
<picture>
  <source media="(prefers-color-scheme: light)" srcset="assets/header-light.svg?v=08a80a9c">
  <source media="(prefers-color-scheme: dark)" srcset="assets/header.svg?v=8802d478">
  <img src="assets/header.svg?v=8802d478" width="100%" alt="Zeffut — 27 dépôts, 26 étoiles, 4854 commits sur 12 mois">
</picture>
