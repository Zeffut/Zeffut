...
<picture>
  <source media="(prefers-color-scheme: light)" srcset="assets/header-light.svg?v=61a41943">
  <source media="(prefers-color-scheme: dark)" srcset="assets/header.svg?v=9936fde3">
  <img src="assets/header.svg?v=9936fde3" width="100%" alt="Zeffut — 27 dépôts, 26 étoiles, 4839 commits sur 12 mois">
</picture>
