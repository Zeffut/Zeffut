...
<picture>
  <source media="(prefers-color-scheme: light)" srcset="assets/header-light.svg?v=cf0e8f29">
  <source media="(prefers-color-scheme: dark)" srcset="assets/header.svg?v=80b4b05b">
  <img src="assets/header.svg?v=80b4b05b" width="100%" alt="Zeffut — 27 dépôts, 26 étoiles, 4839 commits sur 12 mois">
</picture>
