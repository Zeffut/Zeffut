...
<picture>
  <source media="(prefers-color-scheme: light)" srcset="assets/header-light.svg?v=a30a68d7">
  <source media="(prefers-color-scheme: dark)" srcset="assets/header.svg?v=b229fa5b">
  <img src="assets/header.svg?v=b229fa5b" width="100%" alt="Zeffut — 27 dépôts, 26 étoiles, 4854 commits sur 12 mois">
</picture>
