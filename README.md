...
<picture>
  <source media="(prefers-color-scheme: light)" srcset="assets/header-light.svg?v=81d7e53f">
  <source media="(prefers-color-scheme: dark)" srcset="assets/header.svg?v=e98349b7">
  <img src="assets/header.svg?v=e98349b7" width="100%" alt="Zeffut — 27 dépôts, 26 étoiles, 4854 commits sur 12 mois">
</picture>
